...
const CONFIG = {
  ...
  music: "./music/music.mp3",      // Place your music in the music/ folder

  // ── Theme Colors ──────────────────────────────────────────────
  // A toggle button lets the viewer switch between dark & light mode.
  colors: {
    primary: "#b84cb8",           // Main accent color (rose pink)
    accent: "#e373df",            // Secondary accent color (sky blue)
    dark: {
      background: "#0f172a",      // Slate 900
      text: "#f1f5f9",            // Slate 100
    },
    light: {
      background: "#d25dbd",      // Stone 50
  ...
  sections: [
    ...
    },
    {
      ...
      wishText: "May the force always be with you! ;)",
    },
    {
      type: "fireworks",
      count: 24,
